...
import './Contacts.css'; // Assurez-vous de créer ce fichier CSS pour le style
  ...
  return (
    <div className="contacts-container">
      ...
      <div className="contact-info">
        ...
        <p><strong>LinkedIn</strong> <a href="https://www.linkedin.com/in/lucas-g-b28884306/" target="_blank" rel="noopener noreferrer">My LinkedIn Profile</a></p><br/>
