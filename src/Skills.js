...
function Skills() {
  ...
  const skills = [
    { id: 2, title: 'Java', description: 'Description de la compétence 2', xp: '3 years', level: 'Advanced', image: 'java.png' },
    { id: 1, title: 'JavaScript', description: 'Description de la compétence 1', xp: '3 years', level: 'Intermediate', image: 'js.png' },
    ...
    { id: 12, title: 'HTML', description: 'Description de la compétence 3', xp: '3 years', level: 'Intermediate', image: 'html.png' },
    { id: 9, title: 'PHP', description: 'Description de la compétence 3', xp: '3 months', level: 'Novice', image: 'php.png' },
    { id: 10, title: 'React Native', description: 'Description de la compétence 3', xp: '6 months', level: 'Beginner', image: 'react-native.png' },
    { id: 11, title: 'Swift', description: 'Description de la compétence 3', xp: '1 year', level: 'Intermediate', image: 'swift.png' },
    ...
    { id: 7, title: 'Git', description: 'Description de la compétence 3', xp: '3 year', level: 'Intermediate', image: 'git.png' },
